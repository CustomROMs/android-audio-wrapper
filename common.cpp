...
extern "C" int hw_get_module_by_hmi(const struct hw_module_t **module);
                       ...
                       hw_device_t** device, const char* inst)
{
    ...
    snprintf(module_name, PATH_MAX, "/system/lib/libaudiohw.so");

    //ret = hw_get_module_by_hmi(&module);
